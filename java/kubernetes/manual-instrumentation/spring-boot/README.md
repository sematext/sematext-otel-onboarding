...
helm install sematext-agent sematext/sematext-agent \
  ...
  --set otel.services.java-spring-k8s-manual=java-manual-group \
  --set otel.token-groups.java-manual-group.traces-token=your-traces-token \
  --set otel.token-groups.java-manual-group.logs-token=your-logs-token \
  --set otel.token-groups.java-manual-group.monitoring-token=your-monitoring-token
```
